        ...
        products = [
            {
                ...
                'tagalog_name': 'Moon cactus',
                'description': 'A small, colorful grafted cactus commonly used as a decorative indoor plant.',
                'care_instructions': 'Place in bright, indirect sunlight; water only when soil is dry.',
                'light': 'Bright indirect light',
                'water': 'Low',
                'soil': 'Well-draining cactus soil',
                'temperature': '18–32°C',
                'plant_type': 'Succulent and Cacti',
                'price': 200.00,
                'stock': 50,
